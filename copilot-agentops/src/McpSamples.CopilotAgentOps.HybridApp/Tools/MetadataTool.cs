...
using McpSamples.CopilotAgentOps.HybridApp.Services;
...
public interface IMetadataTool
{
    ...
    /// <summary>
    /// Loads a custom instruction from the copilot-agentops repository.
    /// </summary>
...
/// <summary>
/// This represents the tools entity for metadata served by Copilot AgentOps.
/// </summary>
[McpServerToolType]
