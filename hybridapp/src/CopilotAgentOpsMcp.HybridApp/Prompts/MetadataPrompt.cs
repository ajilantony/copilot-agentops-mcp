...
public class MetadataPrompt : IMetadataPrompt
{
        ...
        [Description("The keyword to search for")] string keyword)
    {
        ...
        1. If the user wants to install it, ask for confirmation then load the content using load_instruction and save to .github/[mode]/ directory with the appropriate filename.
