...
#### 1. Copilot AgentOps Sample
- **Purpose**: Integrates with GitHub's copilot-agentops repository to provide Copilot customizations
- **Key Features**: 
...
feat(copilot-agentops): add search functionality for instructions
